...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        # left leg 1
        pyrosim.Send_Cube(name="LeftLeg", pos=[-0.5,0.35,0], size=[1.0,0.2,0.2])
        pyrosim.Send_Joint(name="Torso_LeftLeg", parent="Torso", child="LeftLeg", type="revolute", position=[-0.5,0,1], jointAxis="0 1 0")

        # left leg 2
        pyrosim.Send_Cube(name="LeftLeg2", pos=[-0.5,-0.35,0], size=[1.0,0.2,0.2])
        pyrosim.Send_Joint(name="Torso_LeftLeg2", parent="Torso", child="LeftLeg2", type="revolute", position=[-0.5,0,1], jointAxis="0 1 0")

        # right leg
        pyrosim.Send_Cube(name="RightLeg", pos=[0.5,0.35,0], size=[1.0,0.2,0.2])
        pyrosim.Send_Joint(name="Torso_RightLeg", parent="Torso", child="RightLeg", type="revolute", position=[0.5,0,1], jointAxis="0 1 0")

        # right leg 2
        pyrosim.Send_Cube(name="RightLeg2", pos=[0.5,-0.35,0], size=[1.0,0.2,0.2])
        ...
        # leftlower leg
        pyrosim.Send_Cube(name="LeftLowerLeg", pos=[0,0.35,-0.5], size=[0.2,0.2,1.0])
        pyrosim.Send_Joint(name="LeftLeg_LeftLowerLeg", parent="LeftLeg", child="LeftLowerLeg", type="revolute", position=[-1,0,0], jointAxis="0 1 0")
        
        # leftlower leg 2
        pyrosim.Send_Cube(name="LeftLowerLeg2", pos=[0,-0.35,-0.5], size=[0.2,0.2,1.0])
        ...
        # rightlower leg
        pyrosim.Send_Cube(name="RightLowerLeg", pos=[0,0.35,-0.5], size=[0.2,0.2,1.0])
        pyrosim.Send_Joint(name="RightLeg_RightLowerLeg", parent="RightLeg", child="RightLowerLeg", type="revolute", position=[1,0,0], jointAxis="0 1 0")

        # rightlower leg 2
        pyrosim.Send_Cube(name="RightLowerLeg2", pos=[0,-0.35,-0.5], size=[0.2,0.2,1.0])
    ...
    def Create_Brain(self):
        ...
        pyrosim.Send_Sensor_Neuron(name= 12, linkName= "RightLowerLeg2")
        ...
        pyrosim.Send_Motor_Neuron(name= 22, jointName= "LeftLeg_LeftLowerLeg2")
        pyrosim.Send_Motor_Neuron(name= 23, jointName= "RightLeg_RightLowerLeg")
        pyrosim.Send_Motor_Neuron(name= 24, jointName= "RightLeg_RightLowerLeg2")
